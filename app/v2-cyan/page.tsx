...
/**
 * /v2-cyan — same as /v2 but avatar = real photo, cyan duotone overlay.
 */
export default function V2CyanPage() {
  return (
    <main className="splitform-main">
      ...
      <motion.section
        ...
        aria-label="Profile"
      >
        <div className="profile-avatar profile-avatar-photo profile-avatar-cyan" aria-hidden="true" />
