...
/**
 * /v1 — Breathing variant
 * Card sits BELOW the seven with clear breathing room (no overlap).
 * Whisper-transparent glass. Clean composition: hero → air → passport card.
 */
  ...
  return (
    <main className="splitform-main">
      ...
      <motion.section
        ...
        className="profile-card profile-card-breathing"
        aria-label="Profile"
      >
      ...
      <div style={{ marginTop: 32, fontSize: 10, color: "#666", letterSpacing: "0.1em", textTransform: "uppercase" }}>
        v1 · Breathing (card below logo, no overlap)
      </div>
    </main>
  );
}
