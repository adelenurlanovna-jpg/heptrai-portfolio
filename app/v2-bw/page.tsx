...
/**
 * /v2-bw — same as /v2 but avatar = real photo, B&W monochrome filter.
 */
export default function V2BwPage() {
  return (
    <main className="splitform-main">
      ...
      <motion.section
        ...
        aria-label="Profile"
      >
        <div className="profile-avatar profile-avatar-photo profile-avatar-bw" aria-hidden="true" />
